                    ...
                    <c:if test="${kitList1.limitLeaderid==0}">
                        <table class="layui-table" lay-filter="kittable">
                            <thead>
                                <tr>
                                    <th>
                                        <input name="limitone_${kitList1.limitId}" value="${kitList1.limitId}" lay-filter="limit" lay-skin="primary" title="${kitList1.limitTitle}"  type="checkbox">
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                            <c:forEach items="${kitList}" var="kitList2" >
                                <c:if test="${kitList2.limitLeaderid==kitList1.limitId}">
                                    <tr>
                                        <td>
                                            <input name="limittwo0_${kitList2.limitId}" lay-filter="limit_1" value="${kitList2.limitId}" lay-skin="primary" title="${kitList2.limitTitle}"  type="checkbox">
                                            <input name="limittwo1_${kitList2.limitId}" lay-filter="limit_1_1" value="1" lay-skin="primary" title="增加"  type="checkbox">
