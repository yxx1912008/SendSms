    ...
    <form class="layui-form layui-form-pane" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="kitAdminName" lay-verify="required" placeholder="请输入手机号" autocomplete="off"
        ...
        <div class="layui-form-item">
            ...
            <input name="imgurl" id="imgurl" lay-verify="required" value="" autocomplete="off" class="layui-input"
                   type="hidden">
            <div class=" layui-upload-drag" id="img" style="border-left: 0px;">
                <i class="layui-icon">&#xe654;</i>
                <p>点击上传头像</p>
                <img id="demo1"
                     style="position: absolute;height: 137px;width: 137px;margin: -106px auto auto -30px;display: none"/>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="kitAdminUsername" lay-verify="required" placeholder="请输入用户名" autocomplete="off"
                       class="layui-input" type="text">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="kitAdminPassword" lay-verify="required" placeholder="请输入密码" autocomplete="off"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="kitAdminPasswordAgen" lay-verify="required" placeholder="请输入密码" autocomplete="off"
                       class="layui-input" type="password">
            </div>
        </div>
