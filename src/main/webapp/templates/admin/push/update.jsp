                ...
                <div class="layui-tab-item layui-show">
                        <form class="layui-form layui-form" action="">
                            <div class="layui-form-item">
                                <label class="layui-form-label"><span class="layui-badge-dot"></span> &nbsp;Appkey</label>
                                <div class="layui-input-inline" style="width: 40%">
                                    <input type="text" name="pjAppkey" lay-verify="required" value="${jpash.pjAppkey}" placeholder="" autocomplete="off" class="layui-input">
                                </div>
                                <div class="layui-form-mid layui-word-aux">极光推送提供的Appkey</div>
                            </div>

                            <div class="layui-form-item">
                                <label class="layui-form-label"><span class="layui-badge-dot"></span> &nbsp;Secret</label>
                                <div class="layui-input-inline" style="width: 40%" >
                                    <input type="text" name="pjMastersecret" value="${jpash.pjMastersecret}" lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
                                </div>
                                <div class="layui-form-mid layui-word-aux">极光推送提供的Mastersecret</div>
                            </div>

                            <div class="layui-form-item">
                                <button class="layui-btn" lay-submit="required" lay-filter="jpash">提交</button>
                            </div>
                        </form>
...
map = paySettingService.kitAppPayUnifyAPI(request,response,payUtil);</pre>
    ...
    <script>
        layui.use(['form', 'layedit', 'laydate', 'element', 'layer'], function(){
            ...
            //监听支付宝提交，发送请求
            form.on('submit(jpash)', function(data){

                $.post("<%=basePath%>push/updatePush",data.field,function(d){
                    // 获取 session
                    if(d.code!=200){
