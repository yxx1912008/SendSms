...
public class AdminController {
    ...
    public Object getAllJson(HttpServletRequest request) {
        ...
        // 分页查询
        List<Admin> adminList = adminService.queryPageListByWhere(admin, Integer.valueOf(page),
    ...
    public Object add(HttpServletRequest request) {
        ...
        return JSONObject.toJSON(adminService.save(admin) == 1 ? KitUtil.returnMap("200",
    ...
    public Object update(HttpServletRequest request) {
        ...
        return JSONObject.toJSON(i == 1 ? KitUtil.returnMap("200", StaticFinalVar.UPDATE_OK)
